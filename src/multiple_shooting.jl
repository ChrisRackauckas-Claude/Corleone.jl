...
Return the number of matching constraints generated by `layer`. Single shooting
has no matching constraints; multiple shooting counts state, parameter, and control
continuity constraints in that order.
"""
